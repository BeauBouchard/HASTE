...
public class hasteTweet {
	...
	public hasteTweet(int inc_twitterID, String text)
	{
    ...
    */
	...
	/**
    * getcaptured_at
    * Description - used for getting captured_at, the time which the haste application saved the tweet from twitter
    * @return captured_at - a string which represents the time which the haste application saved the tweet from twitter
    *
    */
